...
class BreathAwareServer:
    ...
    async def queue_request(self, prompt: str, model_name: str = None, 
                           breath_aware: bool = True):
...
async def main():
    ...
    try:
        ...
        from lamina_llm_serve import ModelManager, Server
