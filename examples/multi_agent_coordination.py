...
class BreathAwareAgent:
    ...
    def _check_vows(self, response: str) -> bool:
        ...
        if "human_grounded_lock" in self.vows:
            if any(phrase in response.lower() for phrase in ["you should", "you must", "you need to"]):
                return False
...
class LunaAgent(BreathAwareAgent):
    ...
    async def _specialized_response(self, query: str, context: InteractionContext) -> str:
        ...
        if "analyze" in query.lower():
            ...
            return "The data architecture here has interesting implications. I'm seeing patterns in..."
        else:
...
class VesnaAgent(BreathAwareAgent):
    ...
    async def _specialized_response(self, query: str, context: InteractionContext) -> str:
        ...
        if "safe" in query.lower() or "danger" in query.lower():
            ...
            return "I'm maintaining watchful presence to ensure safe passage through this interaction."
...
async def main():
    ...
    context = InteractionContext(
        user_intent="multi_agent_demo",
        breath_rhythm="conscious_pause",
        emotional_weather="curious"
    )
