...
class ModelManager:
    ...
    def get_default_model(self, use_case: str) -> Optional[str]:
    ...
    def suggest_model(self, requirements: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def get_model_for_agent(self, agent_config: Dict[str, Any]) -> Optional[str]:
        """
        ...
        requirements = {
            'use_case': use_case,
            'category': agent_config.get('category', 'balanced')
        }
