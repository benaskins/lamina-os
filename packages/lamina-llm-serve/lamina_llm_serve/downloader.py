...
class ModelDownloader:
    ...
    def download_model(self, model_name: str, source_config: Dict[str, Any], 
    ...
    def _download_from_huggingface(self, model_name: str, config: Dict[str, Any], 
    ...
    def _download_hf_direct(self, repo_id: str, filename: str, model_name: str,
                           progress_callback: Optional[Callable] = None) -> bool:
    ...
    def _download_from_ollama(self, model_name: str, config: Dict[str, Any],
                             progress_callback: Optional[Callable] = None) -> bool:
    ...
    def _download_from_url(self, model_name: str, config: Dict[str, Any],
                          progress_callback: Optional[Callable] = None) -> bool:
    ...
    def _copy_from_local(self, model_name: str, config: Dict[str, Any],
                        progress_callback: Optional[Callable] = None) -> bool:
    ...
    def _find_ollama_models_dir(self) -> Optional[Path]:
    ...
    def get_download_config(self, model_name: str, source_type: str) -> Optional[Dict[str, Any]]:
