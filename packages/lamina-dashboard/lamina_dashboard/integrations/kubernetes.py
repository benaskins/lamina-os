...
class KubernetesClient:
    ...
    def get_all_services(self) -> List[Dict[str, Any]]:
        ...
        result = self._run_kubectl(["get", "services", "--all-namespaces", "-o", "json"])
        return result.get("items", [])

    def get_all_deployments(self) -> List[Dict[str, Any]]:
        """Get all deployments across all namespaces."""
        result = self._run_kubectl(["get", "deployments", "--all-namespaces", "-o", "json"])
        return result.get("items", [])

    def get_virtual_services(self) -> List[Dict[str, Any]]:
        """Get Istio VirtualServices."""
        result = self._run_kubectl(["get", "virtualservices", "--all-namespaces", "-o", "json"])
        return result.get("items", [])
    ...
    def get_service_endpoints(self, namespace: str, service_name: str) -> Dict[str, Any]:
        ...
        result = self._run_kubectl(
            ["get", "endpoints", "-n", namespace, service_name, "-o", "json"]
        )
        return result
